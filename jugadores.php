...
<head>
    ...
    <title>Preguntados | Batalla</title>
    ...
    <!-- <div class="container theme-showcase" role="main"> -->
        <!-- <div class="row"> -->
            <div class="panel_p ruleta text-center">  
               <!--  <div id="Cortina">
                    <div>
                        <p style="color:white;" class="text-center">Espera tu turno...</p>
                        <img src="img/loading_icon.gif">
                    </div>
                </div> -->
                <h1>Batalla</h1>

                <h3 class="panel-title mt-3" style="text-align: center;">
                    <button type="button" id="btn_ruleta" class="btn btn-success wheel__button1" value="Girar" onclick="IniciarRuleta();" ><strong>Girar</strong></button> </h3>
                    <div class="panel-body-ruleta">
                        <canvas id="canvas" height="302" width="302"></canvas>
                    </div>

                    <div class="panel-header" style="text-align: center;">
                        <!--<button type="button" class="btn btn-success" style="content-align: center" id="salir">Abandonar</button>-->
                        <div class="tabla2" style="content-align: center"><p id="puntaje"></p></div>
                    </div>
                ...
                <input type="hidden" id="idBat" value="<?php echo $_GET['val']; ?>">
                <?php include('footer.php'); ?>
                <script src="js/RuletaSetUp1vs1.js"></script>
                ...
                <script type="text/javascript">
                    ...
                    $("#puntaje").ready(function() {
                        setInterval(function () {My_onLoad($("#idBat").val())}, 2000);
                    });
