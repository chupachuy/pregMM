...
4) Modify any settings in the `builder/manifest.json` file. You can change the name of the "Helvetica Neue", Helvetica, Arial, sans-serif and CSS classname prefix.
